...
export function WorkspaceSwitcher() {
  ...
  return (
    <>
      <SidebarGroupLabel className="w-full justify-between pr-2 px-3 text-xs font-semibold uppercase tracking-wider text-slate-400 mb-0.5">
        ...
        <SidebarMenuItem>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <SidebarMenuButton
                size="sm"
                className="h-9 rounded-md px-2 transition-colors hover:bg-slate-100 data-[state=open]:bg-slate-100 text-slate-700"
              >
                {activeWorkspace ? (
            ...
            >
              ...
              {workspaces?.map((workspace) => (
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-2.5 rounded-md px-2.5 py-2 cursor-pointer text-sm"
                >
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded bg-slate-800 text-white font-semibold text-xs">
              ...
              <DropdownMenuItem
                className="flex items-center gap-2.5 rounded-md px-2.5 py-2 cursor-pointer text-indigo-600 hover:bg-indigo-50 focus:bg-indigo-50 focus:text-indigo-600 text-sm"
                onClick={onOpen}
              >
                <div className="flex h-6 w-6 items-center justify-center rounded border border-dashed border-slate-300">
