                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  <div className="grid gap-6">
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <div className="flex items-center">
                                ...
                                <a
                                  href="#"
                                  className="ml-auto text-xs font-medium text-indigo-600 dark:text-indigo-400 underline-offset-4 hover:underline"
                                >
                    ...
                    <div className="text-center text-sm text-slate-600 dark:text-slate-400 font-medium">
                      ...
                      <Link
                        to="/sign-up"
                        className="font-semibold text-indigo-600 dark:text-indigo-400 underline underline-offset-4 hover:text-indigo-500"
                      >
                        Sign up
                      </Link>
                    </div>
